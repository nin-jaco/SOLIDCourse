...
{   
    ...
    {
        //problem is not in the number of lines, the problem is when a new devicemodel is introduced
        //this violates Martins OCP not Meyers- since adding new devicemodel does not lead to ocp
